! function(e, t) {
    ...
    var s = function() {
        ...
        return e = D, (t = [{ key: "_initializeOptions", value: function(e) { null == e && (e = {}), this.options = { startYear: isNaN(parseInt(e.startYear)) ? null : parseInt(e.startYear), startDate: e.startDate instanceof Date ? e.startDate : null, numberMonthsDisplayed: !isNaN(parseInt(e.numberMonthsDisplayed)) && 0 < e.numberMonthsDisplayed && e.numberMonthsDisplayed <= 12 ? parseInt(e.numberMonthsDisplayed) : 12, minDate: e.minDate instanceof Date ? e.minDate : null, maxDate: e.maxDate instanceof Date ? e.maxDate : null, language: null != e.language && null != D.locales[e.language] ? e.language : "en", allowOverlap: null == e.allowOverlap || e.allowOverlap, displayWeekNumber: null != e.displayWeekNumber && e.displayWeekNumber, displayDisabledDataSource: null != e.displayDisabledDataSource && e.displayDisabledDataSource, displayHeader: null == e.displayHeader || e.displayHeader, alwaysHalfDay: null != e.alwaysHalfDay && e.alwaysHalfDay, enableRangeSelection: null != e.enableRangeSelection && e.enableRangeSelection, disabledDays: e.disabledDays instanceof Array ? e.disabledDays : [], disabledWeekDays: e.disabledWeekDays instanceof Array ? e.disabledWeekDays : [], hiddenWeekDays: e.hiddenWeekDays instanceof Array ? e.hiddenWeekDays : [], roundRangeLimits: null != e.roundRangeLimits && e.roundRangeLimits, dataSource: e.dataSource instanceof Array || "function" == typeof e.dataSource ? e.dataSource : [], style: "background" == e.style || "border" == e.style || "custom" == e.style ? e.style : "border", enableContextMenu: null != e.enableContextMenu && e.enableContextMenu, contextMenuItems: e.contextMenuItems instanceof Array ? e.contextMenuItems : [], customDayRenderer: "function" == typeof e.customDayRenderer ? e.customDayRenderer : null, customDataSourceRenderer: "function" == typeof e.customDataSourceRenderer ? e.customDataSourceRenderer : null, weekStart: isNaN(parseInt(e.weekStart)) ? null : parseInt(e.weekStart), loadingTemplate: "string" == typeof e.loadingTemplate || e.loadingTemplate instanceof HTMLElement ? e.loadingTemplate : null }, this.options.dataSource instanceof Array && (this._dataSource = this.options.dataSource, this._initializeDatasourceColors()) } }, { key: "_initializeEvents", value: function(e) { null == e && (e = []), e.yearChanged && this.element.addEventListener("yearChanged", e.yearChanged), e.periodChanged && this.element.addEventListener("periodChanged", e.periodChanged), e.renderEnd && this.element.addEventListener("renderEnd", e.renderEnd), e.clickDay && this.element.addEventListener("clickDay", e.clickDay), e.dayContextMenu && this.element.addEventListener("dayContextMenu", e.dayContextMenu), e.selectRange && this.element.addEventListener("selectRange", e.selectRange), e.mouseOnDay && this.element.addEventListener("mouseOnDay", e.mouseOnDay), e.mouseOutDay && this.element.addEventListener("mouseOutDay", e.mouseOutDay) } }, {
            ...
            value: function() {
                ...
                if (this.options.displayHeader && this._renderHeader(), e) this._renderLoading();
                    ...
                    t.style.opacity = "0", t.style.display = "flex", t.style.transition = "opacity 0.5s", setTimeout(function() { t.style.opacity = "1", setTimeout(function() { return t.style.transition = "" }, 500) }, 0);
            ...
            value: function() {
                ...
                if (i.innerHTML = "&lsaquo;", a.appendChild(i), t.appendChild(a), this._isFullYearMode()) {
                    ...
                    s.classList.add("year-title"), s.classList.add("year-neighbor2"), s.textContent = (this._startDate.getFullYear() - 2).toString(), null != this.options.minDate && this.options.minDate > new Date(this._startDate.getFullYear() - 2, 11, 31) && s.classList.add("disabled"), t.appendChild(s);
                    var o = document.createElement("th");
                    o.classList.add("year-title"), o.classList.add("year-neighbor"), o.textContent = (this._startDate.getFullYear() - 1).toString(), null != this.options.minDate && this.options.minDate > new Date(this._startDate.getFullYear() - 1, 11, 31) && o.classList.add("disabled"), t.appendChild(o)
                }
                var r = document.createElement("th");
                if (r.classList.add("year-title"), this._isFullYearMode() ? r.textContent = this._startDate.getFullYear().toString() : 12 == this.options.numberMonthsDisplayed ? r.textContent = "".concat(n.startDate.getFullYear(), " - ").concat(n.endDate.getFullYear()) : 1 < this.options.numberMonthsDisplayed ? r.textContent = "".concat(D.locales[this.options.language].months[n.startDate.getMonth()], " ").concat(n.startDate.getFullYear(), " - ").concat(D.locales[this.options.language].months[n.endDate.getMonth()], " ").concat(n.endDate.getFullYear()) : r.textContent = "".concat(D.locales[this.options.language].months[n.startDate.getMonth()], " ").concat(n.startDate.getFullYear()), t.appendChild(r), this._isFullYearMode()) {
                    var l = document.createElement("th");
                    l.classList.add("year-title"), l.classList.add("year-neighbor"), l.textContent = (this._startDate.getFullYear() + 1).toString(), null != this.options.maxDate && this.options.maxDate < new Date(this._startDate.getFullYear() + 1, 0, 1) && l.classList.add("disabled"), t.appendChild(l);
                    var d = document.createElement("th");
                    d.classList.add("year-title"), d.classList.add("year-neighbor2"), d.textContent = (this._startDate.getFullYear() + 2).toString(), null != this.options.maxDate && this.options.maxDate < new Date(this._startDate.getFullYear() + 2, 0, 1) && d.classList.add("disabled"), t.appendChild(d)
                }
            ...
            value: function() {
                ...
                this.options.displayHeader && (this.element.querySelectorAll(".year-neighbor, .year-neighbor2").forEach(function(e) { e.addEventListener("click", function(e) { e.currentTarget.classList.contains("disabled") || s.setYear(parseInt(e.currentTarget.textContent)) }) }), this.element.querySelector(".calendar-header .prev").addEventListener("click", function(e) {
                    if (!e.currentTarget.classList.contains("disabled")) {
                        ...
                        t.style.transition = "margin-left 0.1s", t.style.marginLeft = "100%", setTimeout(function() { t.style.visibility = "hidden", t.style.transition = "", t.style.marginLeft = "0", setTimeout(function() { s.setStartDate(new Date(s._startDate.getFullYear(), s._startDate.getMonth() - s.options.numberMonthsDisplayed, 1)) }, 50) }, 100)
                    }
        ...
        }, { key: "_isFullYearMode", value: function() { return 0 == this._startDate.getMonth() && 12 == this.options.numberMonthsDisplayed } }, {
            key: "getWeekNumber",
            value: function(e) {
        ...
        }, { key: "getYear", value: function() { return this._isFullYearMode() ? this._startDate.getFullYear() : null } }, {
            key: "setYear",
            value: function(e) {
                var t = parseInt(e);
                isNaN(t) || this.setStartDate(new Date(t, 0, 1))
            }
        }, { key: "getStartDate", value: function() { return this._startDate } }, {
            key: "setStartDate",
            value: function(e) {
                var t = this;
        ...
        }, { key: "getWeekStart", value: function() { return null !== this.options.weekStart ? this.options.weekStart : D.locales[this.options.language].weekStart } }, {
            key: "setWeekStart",
            value: function(e) {
                var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1];
